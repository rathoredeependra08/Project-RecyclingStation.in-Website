...
const ComplianceSection = () => {
  return (
    ...
    <section className="relative overflow-hidden bg-gradient-to-br from-green-50 via-white to-green-100 py-20 px-6">
      ...
      <div className="relative z-10 max-w-7xl mx-auto flex flex-col lg:flex-row items-center justify-between gap-12">
        ...
        >
          ...
          <p className="text-gray-600 mb-10 leading-relaxed">
            With <span className="font-semibold text-green-600">Recycling Hub’s</span> waste recycling in Ahmedabad,
        ...
        >
          <motion.div
            ...
            className="relative bg-white shadow-2xl rounded-3xl border border-green-100 p-8 w-[90%] sm:w-[80%] max-w-md"
          >
